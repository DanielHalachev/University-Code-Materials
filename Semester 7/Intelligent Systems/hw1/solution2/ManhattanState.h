...
public:
    ...
    std::priority_queue<ManhattanState<T>, std::vector<ManhattanState<T>>, ManhattanState<T>::Comparator> getNeighbours(Board<T> goal);
...
template<typename T>
std::priority_queue<ManhattanState<T>, std::vector<ManhattanState<T>>, typename ManhattanState<T>::Comparator> ManhattanState<T>::getNeighbours(Board<T> goal) {
    std::priority_queue<ManhattanState<T>, std::vector<ManhattanState<T>>, ManhattanState<T>::Comparator> neighbours;
